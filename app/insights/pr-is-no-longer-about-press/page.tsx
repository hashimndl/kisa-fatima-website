...
const post = posts.find((item) => item.slug === "pr-is-no-longer-about-press");

export const metadata: Metadata = {
  title: post?.title || "PR Is No Longer About Press",
  ...
  return (
    <main>
      <article className="mx-auto max-w-3xl section-pad">
        ...
        <h1 className="font-serif text-5xl leading-tight tracking-[-0.04em] md:text-6xl">PR Is No Longer About Press</h1>
