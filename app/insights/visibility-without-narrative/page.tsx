...
const post = posts.find((item) => item.slug === "visibility-without-narrative");

export const metadata: Metadata = {
  title: post?.title || "Why Visibility Without Narrative Fails",
  ...
  return (
    <main>
      <article className="mx-auto max-w-3xl section-pad">
        ...
        <h1 className="font-serif text-5xl leading-tight tracking-[-0.04em] md:text-6xl">Why Visibility Without Narrative Fails</h1>
