...
const mediaPlatforms = [
  {
    icon: "AR",
    name: "AI Founder Review",
    handle: "aifounderreview.com · founder & editor",
    badge: "My Media Co.",
  ...
  },
  {
    ...
    handle: "@kisafateema",
    badge: "Creator",
    href: "https://www.instagram.com/kisafateema/",
  },
  {
    icon: "LI",
    name: "LinkedIn",
    handle: "linkedin.com/in/kisafatima",
    badge: "Active",
    ...
    <main>
      ...
      <section className="hero">
        <div className="hero-left">
          ...
          <div className="hero-btns">
            ...
            <Link href="#story" className="btn-outline-white">
              Read my story ↓
            </Link>
          </div>
        </div>
      ...
      <section className="ai-strip">
        <div>
          ...
          <div className="ai-tools">
            {[
              ...
              <span className="ai-tool" key={tool}>
                {tool}
              </span>
            ))}
          </div>
        ...
        <blockquote className="ai-quote">
          Automation handles the repetition. I handle the strategy, the story,
          and the soul.
          <span>— Kisa on working with AI</span>
        </blockquote>
      </section>
      ...
      <section className="photo-strip">
        ...
        <div className="photo-accent">
          ...
          <div className="photo-accent-sub">
            Italy. Denmark. Dubai. Pakistan. Same hunger, different skylines.
          </div>
        </div>
      </section>
      ...
      <section className="creative-section">
        ...
        <div>
          {[
            "The belief that drives everything|Life is too short to only learn one thing. I want to learn everything I want to learn and I’m not stopping until I do.",
            "On AI & Automation|I run the AI. The AI doesn’t run me. Tools I use with intention, not dependency.",
            "On building in public|I run a media company. I write. I manage campaigns. I share the process honestly because the messy middle is where the real story is.",
          ].map((card) => (
            <div className="creative-card" key={card}>
              <div className="creative-card-label">{card.split("|")[0]}</div>
              <div className="creative-card-text">{card.split("|")[1]}</div>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="media-list">
          {mediaPlatforms.map((item) => (
            ...
            >
              ...
              <span className="media-label">{item.badge}</span>
            </a>
          ))}
        </div>
      </section>
      ...
      <section id="contact" className="cta-section">
        ...
        <div className="cta-row">
          ...
          <Link className="btn-outline-white" href="/contact">
            Contact details
          </Link>
        </div>
      </section>
