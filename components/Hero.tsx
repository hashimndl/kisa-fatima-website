  ...
  return (
    <section className="mx-auto grid max-w-7xl gap-10 px-6 pb-16 pt-12 lg:grid-cols-[1fr_0.95fr] lg:px-10 lg:pb-24 lg:pt-16">
      <div className="flex flex-col justify-center">
        <p className="mb-5 text-xs font-semibold uppercase tracking-[0.36em] text-olive">
          Kisa Fatima
        </p>
        ...
        <p className="mt-8 max-w-xl text-lg leading-8 text-black/70">
          ...
          building a creator ecosystem powered by AI automation, strategic
          brand intelligence, campaign workflows and creator protection.
        </p>
        ...
        <div className="mt-9 flex flex-col gap-3 sm:flex-row">
          ...
          >
            Work With Kisa <Icon name="arrow" size={16} />
          </Link>
      ...
      <div className="relative min-h-[520px] overflow-hidden bg-[#DED7C9] shadow-2xl shadow-black/10">
        ...
        <div className="absolute inset-x-8 bottom-8 rounded-3xl border border-white/30 bg-white/40 p-6 backdrop-blur-xl">
          ...
          <p className="mt-3 text-sm leading-6 text-black/65">
            Building the future of influencer commerce through automation,
            data, legal protection and intelligent creator-brand partnerships.
          </p>
        </div>
      </div>
    </section>
